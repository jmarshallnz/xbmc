  ...
  namespace Python
  {
    ...
    class PythonLanguageHook : public XBMCAddon::LanguageHook
    {
      ...
      inline PythonLanguageHook() : 
        XBMCAddon::LanguageHook(CINFO_NAME(PythonLanguageHook)), m_interp(NULL)  {  }

    public:

      inline PythonLanguageHook(PyInterpreterState* interp) : 
        XBMCAddon::LanguageHook(CINFO_NAME(PythonLanguageHook)), m_interp(interp)  {  }
      ...
      DECL_CLASS_INFO(PythonLanguageHook)
    };
  }
}
